...
import com.cilys.cars.web.utils.ResUtils;
import com.cilys.cars.web.utils.RootUserIdUtils;
import com.cilys.cars.web.utils.TokenUtils;
...
//                if (RootUserIdUtils.isRootUser(um.get(SQLParam.USER_ID))) {
                    String token = TokenUtils.createToken(String.valueOf(um.getInt(SQLParam.USER_ID)), deviceImei, null);
